import './App.css';
import extensionEvent1 from '../new_theme_image.webp';
  ...
  const agendaDays: AgendaDay[] = [
    ...
    },
    {
      ...
      sessions: [
        ...
        { time: '5:00 PM – 5:15 PM IST', title: 'Thanks Giving for the Event', speaker: 'Event Organizing Team' }
      ]
    }
  ];
      ...
      <main>
        ...
        <section style={{ background: 'linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%)', padding: '4rem 1rem' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '1.25rem', color: '#666', marginBottom: '4rem' }}>
              Celebrating a decade of quantum on the cloud - IBM Qiskit Fall Fest 2026
            </p>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', maxWidth: '600px', margin: '0 auto' }}>
              <div style={{ backgroundColor: 'white', borderRadius: '1rem', padding: '2rem', boxShadow: '0 10px 25px rgba(0, 0, 0, 0.1)', width: '100%', maxWidth: '500px' }}>
                <img src={extensionEvent1} alt="Qiskit Fall Fest 2026 Extension Event - a decade of quantum on the cloud" style={{ width: '100%', height: 'auto', borderRadius: '0.5rem' }} />
                <div style={{ marginTop: '1.5rem', textAlign: 'center' }}>
                  ...
                  <p style={{ color: '#6b7280', fontSize: '1rem', lineHeight: 1.5 }}>
                    ...
                    <span style={{ fontWeight: 600, color: '#7c3aed' }}>Celebrating a decade of quantum on the cloud</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div style={{ backgroundColor: 'white', borderRadius: '1rem', padding: '2rem', marginTop: '3rem', boxShadow: '0 10px 25px rgba(0, 0, 0, 0.1)', maxWidth: '800px', marginLeft: 'auto', marginRight: 'auto' }}>
              <h3 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#111', marginBottom: '1rem' }}>A Decade of Open Access Quantum Computing</h3>
              <p style={{ color: '#555', lineHeight: 1.6, marginBottom: '2rem' }}>
                Join us in celebrating ten years since IBM introduced the world's first open-access quantum computer, and the growth of the quantum ecosystem with IBM Qiskit.
              </p>

              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '2rem', textAlign: 'center' }}>
                <div>
                  <div style={{ fontSize: '2rem', fontWeight: 'bold', color: '#7c3aed' }}>2016</div>
                  <div style={{ fontSize: '0.875rem', color: '#666' }}>Open Access Era Begins</div>
                </div>
                <div>
                  <div style={{ fontSize: '2rem', fontWeight: 'bold', color: '#0066cc' }}>2026</div>
                  <div style={{ fontSize: '0.875rem', color: '#666' }}>Decade of Quantum on the Cloud</div>
                </div>
                <div>
        ...
        <section id="events-section" style={{ backgroundColor: 'white', padding: '4rem 1rem' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '1.25rem', color: '#666', marginBottom: '4rem' }}>
              Four days of intensive quantum computing workshops, talks, and networking across October 7-10, 2026
            </p>
      ...
      <footer style={{ backgroundColor: '#111', color: 'white', padding: '3rem 1rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ borderTop: '1px solid #374151', paddingTop: '2rem', color: '#888' }}>
            <p>© 2026 KL University. Extension Event - A decade of quantum on the cloud.</p>
